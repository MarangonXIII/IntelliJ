...
public class ServidorTCP_Temperatura {
    ...
    public static void main(String[] args) {
        ...
        try (ServerSocket serverSocket = new ServerSocket(12345)) {
            System.out.println("Servidor de Temperatura iniciado na porta 12345...");
    ...
    private static void processarCliente(Socket socket) {
        try (
            ...
            out.println("Bem-vindo ao Servidor de Temperaturas!");
            out.println("Comandos disponíveis: CONSULTAR <cidade>, CADASTRAR <cidade> <temp> <condicao>, LISTAR, SAIR");

            String comando;
            while ((comando = in.readLine()) != null) {
                System.out.println("Comando recebido de " + socket.getInetAddress().getHostAddress() + ": " + comando);
