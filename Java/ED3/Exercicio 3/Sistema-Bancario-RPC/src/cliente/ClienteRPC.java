...
/**
 * Cliente RPC - demonstra o uso transparente do stub
 * O desenvolvedor usa os métodos como se fossem locais
 */
public class ClienteRPC {
    ...
    private void processarOperacao(int operacao) {
        try {
            ...
            // CHAMADA TRANSPARENTE - o desenvolvedor não vê a complexidade de rede
            switch (operacao) {
                case 1:
